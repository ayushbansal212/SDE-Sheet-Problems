    ...
    // no loop will run and no else condition so res.next which is null will be returned
    ...
    // time complexity --> O(M+N) --> both list are traversed completely in worst case
